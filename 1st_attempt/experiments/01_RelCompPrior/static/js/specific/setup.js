var setupTrials = function(items) {
  ...
  for (var i = 0; i < n; i++) {
    ...
    if (curtest === 'prior') {
      ...
      test = [curitem.question_pri1, curitem.question_pri2];
    ...
    // if prior, give her both prior questions; if not, give her a random test question [rel, comp, xor]
    curitem.questions = curitem.isPrior ? _.shuffle(test) : [test];
