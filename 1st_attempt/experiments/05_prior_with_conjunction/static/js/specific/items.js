var items = [
   ...
   "question_priAnd": "It is likely that Mr Gibbs had both a beer and a steak.",
  ...
  {"name"           : "Mrs Sanders' son",
   ...
   "question_priAnd": "It is likely that Ted had both pasta and a pizza.",
  ...
  {"name"           : "Brad's clothes",
   ...
   "question_priAnd": "It is likely that Brad bought both a sweater and a pair of jeans.",
  ...
  {"name"           : "Carl's party",
   ...
   "question_priAnd": "It is likely that Carl danced passionately with both Sue and Mary.",
  ...
  {"name"           : "Tony's clubbing",
   ...
   "question_priAnd": "It is likely that they play both Jazz and Metal at the club tonight.",
  ...
  {"name"           : "Joshua's delay",
   ...
   "question_priAnd": "It is likely that Joshua had to both do his homework and eat lunch.",
  ...
  {"name"           : "Jimmy's trip",
   ...
   "question_priAnd": "It is likely that Jimmy visited both the Statue of Liberty and the Empire State Building.",
  ...
  {"name"           : "Danny's racket",
   ...
   "question_priAnd": "It is likely that Alex bought both a racket and a pair of shoes.",
  ...
  {"name"           : "Pete's accident",
   ...
   "question_priAnd": "It is likely that Pete broke both his arm and his leg.",
  ...
  {"name"           : "Gigi's exams",
   ...
   "question_priAnd": "It is likely that Gigi passed both her Physics exam and her Chemistry exam.",
  ...
  {"name"           : "Leo's wife",
   ...
   "question_priAnd": "It is likely that someone made a hole-in-one on both the first and the second hole.",
  ...
  {"name"           : "Chloe's holiday",
   ...
   "question_priAnd": "It is likely that both Susan and Amelia brought some extra suntan lotion.",
  ...
  {"name"           : "Lily's husband",
   ...
   "question_priAnd": "It is likely that Eric drank both whisky and vodka.",
  ...
  {"name"           : "Gerald's graduation",
   ...
   "question_priAnd": "It is likely that both Gerald's mother and his father attended the ceremony.",
  ...
  {"name"           : "Harold's pet",
   ...
   "question_priAnd": "It is likely that Harold bought both a cat and a dog.",
